      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {userLinks.length === 0 ? (
          <Card className="border-2 border-dashed border-border">
            <CardContent className="flex flex-col items-center justify-center py-16">
              <div className="text-center">
                <p className="text-foreground text-xl font-semibold">No links yet</p>
                <p className="text-muted-foreground text-sm mt-2">Create your first short link to get started</p>
          ...
          <div className="grid gap-4">
            {userLinks.map((link) => (
              <Card key={link.id} className="hover:shadow-lg transition-all duration-200 border border-border">
                <CardHeader className="pb-4 border-b border-border">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground mt-2 truncate" title={link.originalUrl}>
                        {link.originalUrl}
                      </p>
                    </div>
                  </div>
